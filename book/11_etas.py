...
# # 11. ETAS：把餘震邏輯寫成一條式子
#
# 第 5 章與第 10 章給了你兩條經驗律：GR 律（規模怎麼分布）與
# Omori 律（餘震怎麼衰減）。這一章要把它們縫成一個完整的隨機
...
#   這樣，但世界各地擬合出的 $n$ 常在 0.5–0.9，**離臨界不遠**。
#
...
# %% [markdown]
# 擬合出的 $p$ 看起來很合理——但回想第 10 章：池上序列的 $p$
...
#   Marzocchi 2023）乾脆把 $\alpha=\beta$ 與其他五個參數全部
...
# 會觸發什麼」，而問「這個地震**預示**著什麼」。下一章的 EEPAS
# 就是把時間之箭反過來的模型——每一個小地震，都可能是未來
# 更大地震的前兆。
