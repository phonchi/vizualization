...
全站首頁與第 01–23 章皆須在頁末附「參考資料與延伸閱讀」，每頁約 3–5 筆，
依入門到進階排列，搭配官方教材與核心已發表論文；至少一項免費可讀。
每筆提供作者／機構、出版年份（官網未標年份時省略）、可點閱的標題及
1–2 句中文導讀，說明與本章的關係。論文優先連 DOI，有合法免費全文則加列；
需訂閱及預印本版本須標明，不公開本機 PDF，也不引用第 6 節禁止公開的材料。
優先回查 `reference/` 原始文獻，不能只依 PDF 檔名或舊筆記判斷書目。
