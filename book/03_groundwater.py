...
# 原始資料是 1 秒取樣（每天 86,400 筆），教學先重取樣成 1 分鐘平均。
...
# 含水層的彈性性質，有研究主張這些性質在大地震前後會改變，這是震前兆
...
# 觀測井，本身就是一台天然的應變儀，能量到月球與太陽引潮力造成的、
# 只有幾公分的地殼形變。
#
# ## 3.7 不同的井，反應差很多
#
...
# %% [markdown]
# 氣壓效率是水文地質學家描述含水層的一組基本參數之一，也是尋找地震相關
